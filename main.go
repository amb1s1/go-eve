...
var (
	...
	createLab              = flag.Bool("create_lab", true, "create a lab, default to true")
...
func main() {
	flag.Parse()
	out := goeve.Run(*instanceName, *configFile, *createCustomEveNGImage, *createLab, *resetInstance, *stop, *teardown)
